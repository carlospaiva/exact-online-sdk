...
class EmploymentCLA(StrictModel):
    timestamp: Optional[int] = Field(None, alias="Timestamp")
    id: Optional[UUID] = Field(None, alias="ID")
    cla: Optional[UUID] = Field(None, alias="CLA")
    cla_code: Optional[str] = Field(None, alias="CLACode")
    cla_description: Optional[str] = Field(None, alias="CLADescription")
