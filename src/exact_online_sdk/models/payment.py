...
class Payment(StrictModel):
    ...
    payment_batch_number: Optional[int] = Field(None, alias="PaymentBatchNumber")
    ...
    payment_selected: Optional[datetime] = Field(None, alias="PaymentSelected")
    payment_selector: Optional[UUID] = Field(None, alias="PaymentSelector")
    payment_selector_full_name: Optional[str] = Field(
        None, alias="PaymentSelectorFullName"
    )
